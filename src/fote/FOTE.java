...
public class FOTE {
    ...
    public static void main(String[] args) {
        ...
        MongoHelper.save(new User("Test brah2", "Name", "sadmin", "sadmin"), "users");
        MongoHelper.getCollection("proposals").drop();
        ArrayList<String> options = new ArrayList<String>();
        options.add("yes");
        options.add("no");
        MongoHelper.getCollection("comments").drop();
        MongoHelper.save(new Comment("swag", new Integer(0)), "comments");
        MongoHelper.save(new Comment("derp", new Integer(1)), "comments");
